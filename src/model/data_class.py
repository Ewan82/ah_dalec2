...
class DalecData:
    ...
    def __init__(self, start_date=None, end_date=None, ob_str=None,
        ...
        self.sigo_donset = 5.
        self.sigo_dfall = 7.
        self.nee_day_scale = 0.08  # 0.03  # 0.05
        self.nee_night_scale = 2*0.08  # 0.03*3  # 0.15
    ...
    def assimilation_obs(self, ob_str, data, scale_nee=0):
        ...
        if scale_nee == 1:
            if 'nee_day' in obs_dict.keys():
                obs_err_dict['nee_day'] = abs(obs_dict['nee_day'])*self.nee_day_scale + 1. #0.45 #0.71
            if 'nee_night' in obs_dict.keys():
                obs_err_dict['nee_night'] = abs(obs_dict['nee_night'])*self.nee_night_scale + 2. #0.45*3 #1.2
